      ...
      <div className="w-full max-w-lg bg-gray-800 p-8 rounded-3xl shadow-2xl border border-gray-700 animate-zoom-in">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div className="group">
            <label
              htmlFor="name"
              className="block text-sm font-medium text-gray-300 mb-1 transition-colors group-focus-within:text-blue-400"
            >
              Your Name
            </label>
            <input
          ...
          <div className="group">
            <label
              htmlFor="email"
              className="block text-sm font-medium text-gray-300 mb-1 transition-colors group-focus-within:text-purple-400"
            >
              Email Address
            </label>
            <input
          ...
          <div className="group">
            <label
              htmlFor="message"
              className="block text-sm font-medium text-gray-300 mb-1 transition-colors group-focus-within:text-indigo-400"
            >
              Message
            </label>
            <textarea
